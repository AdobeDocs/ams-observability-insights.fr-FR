---
title: Étude des problèmes d’application
description: Utilisez l’API Observability Insights pour trier les problèmes de latence, d’erreur et de débit dans AEM Managed Services.
feature: Operations
role: Admin
...
# Étude des problèmes d’application
